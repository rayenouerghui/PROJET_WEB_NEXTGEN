        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            try {
                ...
                if (empty($titre) || empty($date_evenement)) {
                    ...
                    $this->redirect('/projet/index.php?c=evenement&amp;a=index');
                    return;
                }
            ...
            try {
                ...
                $this->render('admin/event_create', $data);
            } catch (Exception $e) {
    ...
    public function edit()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            try {
                ...
                if (empty($titre) || empty($date_evenement)) {
                    $this->setFlash('error', 'Le formulaire contient des erreurs.');
                    $this->redirect('/projet/index.php?c=evenement&amp;a=edit&amp;id=' . $id);
                    return;
                }
            ...
            try {
                ...
                $this->render('admin/event_edit', $data);
            } catch (Exception $e) {
                die('Erreur: ' . $e->getMessage());
            }
        }
