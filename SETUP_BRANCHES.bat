@echo off
REM Script Windows pour créer toutes les branches du projet NextGen
REM Usage: SETUP_BRANCHES.bat

echo 🌿 Création des branches pour NextGen...

REM Se placer sur main
git checkout main

REM Créer les branches pour chaque module
