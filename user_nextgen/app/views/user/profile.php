...
<div style="margin: 2rem 0; display: flex; gap: 1rem;">
  <a href="/user_nextgen/profile/edit" style="padding: 0.75rem 1.5rem; background: #007bff; color: white; text-decoration: none; border-radius: 4px;">Modifier mon profil</a>
