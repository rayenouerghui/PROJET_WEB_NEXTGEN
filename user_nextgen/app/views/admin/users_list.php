        ...
        <tr>
          ...
          <td>
            <div style="display: flex; gap: 0.25rem; flex-wrap: wrap;">
              <a href="/user_nextgen/admin/users/view?id=<?= $u['id_user'] ?>" style="padding: 0.25rem 0.5rem; background: #17a2b8; color: white; text-decoration: none; border-radius: 4px; font-size: 0.75rem;">👁️ Voir</a>
              <a href="/user_nextgen/admin/users/edit?id=<?= $u['id_user'] ?>" style="padding: 0.25rem 0.5rem; background: #007bff; color: white; text-decoration: none; border-radius: 4px; font-size: 0.75rem;">✏️ Éditer</a>
              ...
              <?php if ($u['id_user'] !== $_SESSION['user']['id_user']): ?>
                <form action="/user_nextgen/admin/users/delete" method="POST" style="display: inline; margin: 0;" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?');">
                  ...
                  <button type="submit" class="btn-small btn-danger" style="padding: 0.25rem 0.5rem; font-size: 0.75rem;">🗑️ Supprimer</button>
                </form>
              <?php else: ?>
