...
<div class="homepage">
        ...
        <div class="container">
            <div class="hero-card">
                ...
                <div class="hero-buttons">
                    <a href="/projet/index.php?c=front&amp;a=events" class="btn btn-primary">Découvrir les événements</a>
                    <a href="/projet/index.php?c=front&amp;a=categories" class="btn btn-secondary">Voir les catégories</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="features-section">
        <div class="container">
            ...
            <div class="hero-buttons">
                <a href="/projet/index.php?c=front&amp;a=events" class="btn btn-primary btn-large">🟩 Je participe maintenant</a>
            </div>
        </div>
    </section>
</div>
