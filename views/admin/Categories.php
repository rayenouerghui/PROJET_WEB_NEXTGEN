...
<div class="admin-container">
    <div class="admin-page-header">
        ...
        <a href="/projet/index.php?c=categorie&amp;a=create" class="btn btn-add">+ Ajouter une catégorie</a>
    </div>
                ...
                <?php else: ?>
                    <?php foreach ($categories as $cat): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/projet/index.php?c=categorie&amp;a=edit&amp;id=<?php echo $cat['id_categorie']; ?>" class="btn-admin btn-edit">Modifier</a>
                                          <a href="/projet/index.php?c=categorie&amp;a=delete&amp;id=<?php echo $cat['id_categorie']; ?>" 
