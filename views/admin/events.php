...
<div class="admin-container">
    <div class="admin-page-header">
        ...
        <a href="/projet/index.php?c=evenement&amp;a=create" class="btn btn-add">+ Ajouter un événement</a>
    </div>
                ...
                <?php else: ?>
                    <?php foreach ($evenements as $evt): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/projet/index.php?c=evenement&amp;a=edit&amp;id=<?php echo $evt['id_evenement']; ?>" class="btn-admin btn-edit">Modifier</a>
                                          <a href="/projet/index.php?c=evenement&amp;a=delete&amp;id=<?php echo $evt['id_evenement']; ?>" 
