...
<div class="admin-container">
    ...
    <div class="form-card">
        <form id="categoryEditForm" class="validate-admin" method="post" action="/projet/index.php?c=categorie&amp;a=edit&amp;id=<?php echo $categorie['id_categorie'] ?? ''; ?>" novalidate>
            ...
            <div class="form-actions">
                ...
                <a href="/projet/index.php?c=categorie&amp;a=index" class="btn btn-secondary">Annuler</a>
            </div>
        </form>
    </div>
</div>
