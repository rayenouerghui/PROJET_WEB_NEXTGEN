...
<head>
    ...
    <link rel="stylesheet" href="/projet/public/css/back.css" type="text/css" />
    <script src="/projet/public/js/disable-html5.js"></script>
    <script src="/projet/public/js/admin-modals.js"></script>
</head>
<body>
    ...
    <div class="admin-layout">
        <aside class="admin-sidebar">
            ...
            <nav class="sidebar-menu">
                <a class="item active" href="/projet/index.php?c=admin&amp;a=dashboard">
                    <span>Dashboard</span>
                </a>
                <a class="item" href="/projet/index.php?c=categorie&amp;a=index">
                    <span>Catégories</span>
                </a>
                <a class="item" href="/projet/index.php?c=evenement&amp;a=index">
                    <span>Événements</span>
                </a>
                <a class="item" href="/projet/index.php?c=reservation&amp;a=index">
                    <span>Réservations</span>
                </a>
            </nav>
            <div class="sidebar-actions">
                <a href="/projet/index.php?c=front&amp;a=index">Voir le Site</a>
            </div>
        </aside>
