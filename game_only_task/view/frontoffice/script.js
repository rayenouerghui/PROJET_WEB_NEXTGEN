document.addEventListener('DOMContentLoaded', function () {
    ...
    // ===== ADMIN TABLE: SEARCH + FILTER + SORT =====
    if (document.body.classList.contains('admin-layout') && $('.admin-main')) {
        ...
        $$('thead th').forEach((th, idx) => {
            if (idx === 1 || idx === 5) return; // skip image & actions
    ...
    // ===== FRONTOFFICE CATALOG FILTER & SORT =====
    ...
    // ===== FORM VALIDATION + IMAGE PREVIEW (ajouter.php & modifier.php) =====
    ...
    if (form && form.enctype === 'multipart/form-data') {
        ...
        // Custom validation (runs because we use novalidate)
        form.addEventListener('submit', e => {
            ...
            // Image required only on ajouter.php
