...
<div class="flex min-h-screen">
  ...
  <aside :class="sidebarOpen ? 'w-64' : 'w-20'" 
    ...
    <nav class="flex-1 px-4 py-6 space-y-2">
      ...
      <a href="mes_reclamations.php" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition text-left hover:bg-teal-50 text-gray-700 hover:text-teal-600">
        <i class="fas fa-list text-xl"></i>
        <span :class="{ 'hidden': !sidebarOpen }">Mes réclamations</span>
      </a>
