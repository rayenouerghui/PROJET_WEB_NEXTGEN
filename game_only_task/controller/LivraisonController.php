<?php
// controller/LivraisonController.php
...
class LivraisonController
{
    ...
    public function getLivraisonById(int $id): ?Livraison
    {
        ...
        // Propriétés virtuelles pour l'affichage
    ...
    // Récupère la livraison en cours de l'utilisateur (1 max)
    ...
    // Toutes les livraisons (pour admin)
    public function getAllLivraisons(): array
    {
        $sql = "SELECT l.*, u.prenom, u.nom, j.titre AS nom_jeu 
                FROM livraisons l 
        ...
        foreach ($results as $row) {
            ...
            $livraison->prenom_user = $row['prenom'];
            $livraison->nom_user = $row['nom'];
            $livraison->nom_jeu = $row['nom_jeu'];
