            ...
            <div class="account-content">
                <div class="account-sidebar">
                    <ul class="account-menu">
                        ...
                        <li><a href="#donations">Mes Dons</a></li>
                ...
                <div class="account-main">
                    ...
                    <!-- Donations Tab -->
                    <div id="donations" class="account-tab">
                        <h2>Mes Contributions</h2>
                        <div class="donations-summary">
                            <div class="stat-card">
                                <div class="stat-number" id="userTotalDonated">0 €</div>
                                <div class="stat-label">Total Donné</div>
                            </div>
                            <div class="stat-card">
                                <div class="stat-number" id="userDonationsCount">0</div>
