...
<?php else: ?>
  <div style="margin-top: 2rem;">
    ...
    <div style="display: flex; gap: 1rem; margin-top: 1rem;">
      ...
      <a href="/user_nextgen/history" style="padding: 1rem 2rem; background: #17a2b8; color: white; text-decoration: none; border-radius: 4px;">Mon Historique</a>
      <?php if ($_SESSION['user']['role'] === 'admin'): ?>
        <a href="/user_nextgen/admin/dashboard" style="padding: 1rem 2rem; background: #ffc107; color: #333; text-decoration: none; border-radius: 4px;">Dashboard Admin</a>
      <?php endif; ?>
    </div>
  </div>
<?php endif; ?>
