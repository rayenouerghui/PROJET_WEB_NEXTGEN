    ...
    public function create()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            try {
                ...
                $this->redirect(WEB_ROOT . '/index.php?c=categorie&a=index');
            } catch (Exception $e) {
            ...
            if (isset($_GET['partial']) && $_GET['partial']) {
                $data = [ 'old' => [], 'errors' => [] ];
                $this->render('partials/category_form', $data);
                return;
            }
            $this->index();
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            try {
                ...
                if (empty($nom)) {
                    ...
                    $this->render('categorie_edit', $data);
                    return;
                }
                ...
                $this->redirect(WEB_ROOT . '/index.php?c=categorie&a=edit&id=' . urlencode($id));
            }
        } else {
            try {
                $categorie = $this->getById($id);
