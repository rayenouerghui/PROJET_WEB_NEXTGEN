...
<div class="flex min-h-screen">
  ...
  <aside :class="sidebarOpen ? 'w-64' : 'w-20'" 
    ...
    <nav class="flex-1 px-4 py-6 space-y-2">
      ...
      <a href="admin_blog.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition <?= $current==='admin_blog.php' ? 'bg-teal-50 text-teal-600 font-medium' : 'hover:bg-teal-50 text-gray-700 hover:text-teal-600' ?>">
        <i class="fas fa-blog text-xl"></i>
        <span :class="{ 'hidden': !sidebarOpen }">Blog</span>
      </a>
      <a href="admin_events.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition <?= $current==='admin_events.php' ? 'bg-teal-50 text-teal-600 font-medium' : 'hover:bg-teal-50 text-gray-700 hover:text-teal-600' ?>">
        <i class="fas fa-calendar-alt text-xl"></i>
        <span :class="{ 'hidden': !sidebarOpen }">Événements</span>
      </a>
    </nav>
