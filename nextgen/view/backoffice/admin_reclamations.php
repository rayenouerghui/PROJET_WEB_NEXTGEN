...
<body class="h-full" x-data="{ sidebarOpen: true }">
  ...
  <aside :class="sidebarOpen ? 'sidebar-open' : 'sidebar-closed'" 
    ...
    <nav class="flex-1 px-3 py-6 space-y-2">
      ...
      <a href="admin_blog.php" class="flex items-center space-x-4 px-4 py-3 rounded-lg transition hover:bg-white/10 text-purple-300">
        <i class="fas fa-blog w-8 text-xl"></i><span x-show="sidebarOpen">Blog</span>
      </a>
      <a href="admin_events.php" class="flex items-center space-x-4 px-4 py-3 rounded-lg transition hover:bg-white/10 text-purple-300">
