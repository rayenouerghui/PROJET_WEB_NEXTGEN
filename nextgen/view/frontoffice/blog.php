...
require_once  '../../controller/ArticleRatingController.php';
require_once   '../../controller/AISummaryController.php'; // NOUVEAU

$blogController = new BlogController();
$commentController = new CommentController(); // Uses CommentModel internally
...
<head>
  ...
  margin-top: auto; /* This pushes it to the bottom when content is short */
  width: 100%;
}
...
<footer>
  <div class="container" style="display: flex; flex-direction: column; align-items: center; gap: 8px;">
    <h3 style="font-size: 2rem; margin: 0;">NextGen</h3>
    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Plateforme de vente de jeux vidéo à vocation solidaire</p>
    <p style="margin: 8px 0 0 0; font-size: 0.85rem; opacity: 0.6;">© 2025 NextGen. Tous droits réservés.</p>
  </div>
</footer>
