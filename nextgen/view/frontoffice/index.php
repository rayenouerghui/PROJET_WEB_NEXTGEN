...
<head>
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .hero{
      min-height:100vh;
      background:url('<?php echo WEB_ROOT; ?>/resources/gamer-ezgif.com-added-text.gif') center/cover no-repeat fixed;
...
<header>
    <div class="container nav">
      ...
      <a href="index.php" class="logo">
        <img src="<?php echo WEB_ROOT; ?>/resources/nextgen.png" alt="NextGen Logo" style="height: 100px; width:auto;position:relative; left:-20%;!important">
      </a>
        
        <nav class="menu" style="position:absolute;left:300px; !important">
          <a href="index.php" class="active">Accueil</a>
          <a href="catalogue.php">Produits</a>
          <a href="blog.php"><i class="bi bi-journal-text"></i> Blog</a>
          <a href="<?php echo WEB_ROOT; ?>/index.php?c=front&a=events"><i class="bi bi-calendar-event"></i> Événements</a>
...
<section class="hero">
  <div class="container" style="position:relative;">
    ...
    <div>
      ...
      <a href="blog.php" class="btn btn-secondary" style="margin: 0 10px;">Lire le Blog</a>
      <a href="<?php echo WEB_ROOT; ?>/index.php?c=front&a=events" class="btn btn-secondary">Voir les Événements</a>
    </div>
  </div>
</section>
