<?php include __DIR__ . '/header.php'; ?>
    ...
    <div class="events-page events-page--categories">
        ...
        <div id="categoriesContainer" class="categories-grid">
            <?php if (!empty($categories_js)): ?>
                <?php foreach ($categories_js as $cat): ?>
                    ...
                    <a class="event-card category-card" href="<?php echo WEB_ROOT; ?>/index.php?c=front&amp;a=events&amp;cat=<?php echo htmlspecialchars($cat['id']); ?>" data-cat="<?php echo htmlspecialchars($cat['id']); ?>">
...
<script>
// reservation behaviors for preview are provided by front-events.js
