...
<div class="admin-container">
    ...
    <div class="form-card">
        <form id="reservationCreateForm" class="validate-admin" method="post" action="<?php echo WEB_ROOT; ?>/index.php?c=reservation&amp;a=create" novalidate>
            <div class="form-grid">
            ...
            <div class="form-actions">
                ...
                <a href="<?php echo WEB_ROOT; ?>/index.php?c=reservation&amp;a=index" class="btn btn-secondary">Annuler</a>
            </div>
        </form>
    </div>
</div>
