    ...
    <div class="dashboard-grid">
        ...
        <div class="dashboard-card">
            <div class="card-header">
                ...
                <a href="<?php echo WEB_ROOT; ?>/index.php?c=reservation&amp;a=index" class="btn-link">Voir tout</a>
            </div>
        ...
        <div class="dashboard-card">
            <div class="card-header">
                ...
                <a href="<?php echo WEB_ROOT; ?>/index.php?c=evenement&amp;a=index" class="btn-link">Voir tout</a>
            </div>
            <div class="table-responsive">
                <table class="admin-table">
                    <thead>
