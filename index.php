...
if ($controller === 'matchmaking' || strpos($path, '/api/') !== false || strpos($path, 'matchmaking') !== false) {
    ...
    if ($isAdmin) {
        ...
        try {
            require_once __DIR__ . '/app/Controllers/backoffice/AttenteMatchController.php';
            require_once __DIR__ . '/app/Controllers/backoffice/SessionMatchController.php';
    ...
    if (strpos($path, '/backoffice/') !== false) {
        header('Location: public/backoffice/matchmaking.php');
    } else {
        header('Location: public/frontoffice/matchmaking.php');
    }
    exit;
}
